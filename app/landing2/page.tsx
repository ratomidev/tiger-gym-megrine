  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <header className="fixed top-0 w-full z-50 bg-black/90 backdrop-blur-sm border-b border-red-900/20">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex space-x-8">
            <Link href="#home" className="text-white hover:text-red-400 transition-colors">
              Accueil
            </Link>
            <Link href="#plans" className="text-white hover:text-red-400 transition-colors">
              Abonnements
            </Link>
          ...
          <Button onClick={handleRegisterClick} className="bg-red-600 hover:bg-red-700 text-white">Rejoindre</Button>
        </div>
      </header>

      {/* Hero Section with Carousel */}
      <section id="home" className="relative h-screen flex mt-19 items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-4">
          <Badge className="mb-6 bg-red-600/20 text-red-400 border-red-600/30">Expérience Fitness Premium</Badge>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
            LIBÉREZ VOTRE
            <span className="block text-red-500">TIGRE INTÉRIEUR</span>
          </h1>
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Transformez votre corps et votre esprit dans l'installation de fitness la plus avancée de Megrine. Là où les champions sont façonnés.
          </p>
        </div>
        ...
        <div className="absolute bottom-20 left-1/2 transform -translate-x-1/2 w-full max-w-4xl px-4">
          <div className="grid grid-cols-3 gap-8 text-center">
            ...
            <div>
              ...
              <div className="text-sm text-gray-400">Entraineurs professionels</div>
            </div>
            <div>
      ...
      <section className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Pourquoi Choisir Tiger Gym?</h2>
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Découvrez la différence avec nos installations de classe mondiale et nos entraîneurs experts
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Card className="bg-black border-red-900/20 text-white">
              ...
              <CardContent>
                <p className="text-gray-400 text-center">
                  Équipement de fitness à la pointe de la technologie des meilleures marques pour des résultats d'entraînement optimaux
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-black border-red-900/20 text-white">
              ...
              <CardContent>
                <p className="text-gray-400 text-center">
                  Entraîneurs personnels certifiés dédiés à vous aider à atteindre vos objectifs de fitness
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-black border-red-900/20 text-white">
              ...
              <CardContent>
                <p className="text-gray-400 text-center">
                  Entraînez-vous selon votre emploi du temps avec un accès à la salle 24h/24 pour les membres premium
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section id="plans" className="py-20 bg-black">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Choisissez la formule parfaite qui correspond à votre parcours fitness et à votre budget
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            ...
            <Card className="bg-gray-900 border-gray-700 text-white relative">
              <CardHeader className="text-center pb-8">
                ...
                <CardDescription className="text-gray-400">(1 mois gratuit)</CardDescription>
                <div className="mt-4">
                  <span className="text-4xl font-bold">200</span>
                  <span className="text-gray-400"> TND</span>
                  <div className="text-sm mt-1 text-gray-400">(3 mois d'accès)</div>
                </div>
              </CardHeader>
            ...
            <Card className="bg-red-600 border-red-500 text-white relative transform scale-105 z-10">
              ...
              <CardHeader className="text-center pb-8">
                ...
                <CardDescription className="text-red-100">(1 mois gratuit)</CardDescription>
                <div className="mt-4">
                  <span className="text-4xl font-bold">250</span>
                  <span className="text-red-100"> TND</span>
                  <div className="text-sm mt-1 text-red-200">(4 mois d'accès)</div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
            ...
            <Card className="bg-gray-900 border-gray-700 text-white relative">
              ...
              <CardHeader className="text-center pb-8">
                ...
                <CardDescription className="text-gray-400">Coaching privé inclus</CardDescription>
                <div className="mt-4">
                  <span className="text-4xl font-bold">200</span>
                  <span className="text-gray-400"> TND</span>
                  <div className="text-sm mt-1 text-gray-400">(Accès de 7h à 12h)</div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
            ...
            <Card className="bg-gray-900 border-gray-700 text-white relative md:col-span-1 lg:col-span-1 md:transform md:scale-100 lg:scale-105">
              ...
              <CardHeader className="text-center pb-8">
                ...
                <CardDescription className="text-gray-400">Prix exceptionnel</CardDescription>
                <div className="mt-4">
                  <div className="flex items-center justify-center">
                    <span className="text-4xl font-bold">360</span>
                    <span className="text-gray-400"> TND</span>
                  </div>
                  <div className="text-sm line-through text-gray-500 mt-1">720 TND</div>
                  <div className="text-sm mt-1 text-green-500">Économisez 360 TND</div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
            ...
            <Card className="bg-gradient-to-br from-red-900 to-black border-red-700 text-white relative md:col-span-2 lg:col-span-1">
              ...
              <CardHeader className="text-center pb-8">
                ...
                <CardDescription className="text-red-300">Notre meilleure offre</CardDescription>
                <div className="mt-4">
                  <div className="flex items-center justify-center">
                    <span className="text-4xl font-bold">600</span>
                    <span className="text-red-300"> TND</span>
                  </div>
                  <div className="text-sm line-through text-gray-500 mt-1">1200 TND</div>
                  <div className="text-sm mt-1 text-green-400">Économisez 600 TND</div>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center space-x-3">
      ...
      <section id="about" className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">À Propos de Tiger Gym Megrine</h2>
            <p className="text-gray-400 text-lg max-w-3xl mx-auto">
              Situé au cœur de Megrine, Tiger Gym est la destination fitness de référence depuis plus de 5 ans,
              aidant des milliers de personnes à transformer leur vie grâce au fitness.
            </p>
          </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-400 mb-4">
                  Tiger Gym Megrine a été fondé avec une mission simple : créer une communauté fitness où chacun
                  se sent accueilli et encouragé à atteindre ses objectifs. Notre installation à la pointe
                  combine équipements dernier cri et accompagnement expert.
                </p>
                <p className="text-gray-400">
                  Que vous soyez débutant faisant vos premiers pas dans le fitness ou un athlète aguerri repoussant vos
                  limites, notre équipe d'entraîneurs certifiés est là pour soutenir votre parcours à chaque étape.
                </p>
              </div>
              ...
              <div >
                ...
                <p className="text-gray-400 mb-6">
                  Restez connecté et recevez quotidiennement motivation, conseils d'entraînement et actualités de Tiger Gym Megrine.
                </p>
      ...
      <section className="py-20 bg-red-600">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-4 text-white">Prêt à Commencer Votre Transformation?</h2>
          <p className="text-xl text-red-100 mb-8 max-w-2xl mx-auto">
            Rejoignez Tiger Gym Megrine aujourd'hui et devenez membre de notre famille fitness. Votre meilleure version vous attend.
          </p>
      ...
      <footer className="bg-black py-12 border-t border-red-900/20">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm">
                Transformez votre corps et votre esprit dans la meilleure salle de sport de Megrine.
              </p>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2 text-sm">
                <Link href="#home" className="text-gray-400 hover:text-red-400 block">
                  Accueil
                </Link>
                <Link href="#plans" className="text-gray-400 hover:text-red-400 block">
                  Formules d'Abonnement
                </Link>
                <Link href="#about" className="text-gray-400 hover:text-red-400 block">
                  À Propos
                </Link>
              </div>
            </div>
            ...
            <div>
              <h4 className="text-white font-semibold mb-4">Informations de Contact</h4>
          ...
          <div className="border-t border-red-900/20 mt-8 pt-8 text-center">
            <p className="text-gray-400 text-sm">© 2025 Tiger Gym Megrine. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
    </div>
